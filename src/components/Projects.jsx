...
const projects = [
    ...
    { title: 'Dice Roll Game', url: "https://rohit-kumar-76.github.io/Dice_Roll/", description: 'The Dice Game is an interactive web game where players select a number between 1 and 6 and then roll a virtual dice. Players score points if their selected number matches the rolled dice number, with the rolled number being added to their score. A penalty of -2 points is applied after two consecutive incorrect guesses. The game features a responsive interface built with Tailwind CSS, including a total score display, selectable numbers, and game rules.' },
